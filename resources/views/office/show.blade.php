  ...
  <div class="row">
    <form>
      <div class="form-group">
        ...
        <input type="text" class="form-control txtbx" id="office_name" value="{{$office->post_number}}" readonly><br><br>
        <label for="office_name">所在地</label>
        <input type="text" class="form-control txtbx" id="office_name" value="{{$office->address}}" readonly><br><br>
        <label for="office_name">電話番号</label>
        <input type="text" class="form-control txtbx" id="office_name" value="{{$office->telnumber}}" readonly><br><br>
      </div>
    </form>
  </div>
  <div class="row">
